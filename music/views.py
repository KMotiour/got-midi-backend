...
from .serializers import( MusicCreateSerializers, MusicRUDSerializers, OwnedMusicSerializer, 
                        ...
                        SearchSongReviewSerializers, TopMusicSerializer, ExtraInfoSerializer, UploadMusicMenuallySerialisers
                        )
...
class UploadMusicMenually(CreateAPIView):
    # permission_classes = [IsAdminUser]
    serializer_class = UploadMusicMenuallySerialisers
    queryset = Musics.objects.all()
